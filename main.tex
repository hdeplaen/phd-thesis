...
%%% COVER: Settings %%%
\title{Optimal Transport and Kernel Methods}
%\subtitle{Multiscale computing for Dummies}

\author{Henri}{De Plaen}

\supervisor{Prof.~dr.~ir.~J.~A.~K.~Suykens}{}
\president{Prof.~dr.~ir.~The~Chairman}{}
\jurymember{Prof.~dr.~ir.~P.~Patrinos}{}
\jurymember{Prof.~dr.~ir.~K.~Meerbergen}{}
\jurymember{Prof.~dr.~T.~Tuytelaars}{}
